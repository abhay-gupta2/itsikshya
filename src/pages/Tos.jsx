    ...
    <>
      ...
      <section className='my-6 bg-white max-w-[1400px] mx-auto'>
        <div className="container mx-auto">
          <p>Welcome to IT Sikshya. By enrolling in or participating in our Hybrid/Online 100-day Internship Program, you agree to comply with and be bound by the following Terms of Service. IT Sikshya is based at Rem.Work, Kamalpokhri, Kathmandu, Nepal.</p>

          <h2 className='text-[20px] font-bold pt-4'>1. Eligibility</h2>
          <p>Our internship program is open to students and recent graduates from any university worldwide who are proficient in English and motivated to pursue a career in Information Technology.</p>

          <h2 className='text-[20px] font-bold pt-4'>2. Program Delivery</h2>
          <p>The internship is conducted online or through a hybrid model, allowing participants to join from any location with reliable internet access. IT Sikshya reserves the right to adjust program content, format, or schedule to maintain educational quality and effectiveness.</p>
          ...
          <p>All training materials, project content, and resources provided during the internship remain the property of IT Sikshya or its partners. Participants are granted a limited, non-transferable license to use these materials solely for educational purposes within the internship.</p>
          ...
          <p>Personal information collected during the application and internship process will be handled in accordance with IT Sikshya’s Privacy Policy and applicable data protection laws.</p>
