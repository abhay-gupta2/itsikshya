...
function Privacy() {
  useEffect(() => {
    document.title = "IT Sikshya Privacy | Professional Marketplace"
  }, []);
  return (
    <>
      <section className='w-full mx-auto'>
        <h4 className='text-[36px] font-semibold text-white my-5 px-[130px] py-10 bg-[#8D8D8D]'><Link to={'/'}>Training</Link> / <span className='text-[20px] font-[400] text-[#eeee]'>Privacy</span></h4>
