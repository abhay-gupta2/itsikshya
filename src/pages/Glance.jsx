...
function About() {
  useEffect(() => {
    document.title = "Glance | IT Sikshya"
  }, []);
  return (
    <>
      <section className='w-full mx-auto bg-[#8D8D8D]'>
        <div className="container mx-auto py-[40px]">
          <h4 className='text-[36px] font-semibold text-white'><Link to={'/'}>Training</Link> / <span className='text-[20px] font-[400] text-[#eeee]'>Glance</span></h4>
        </div>
      </section>
            ...
            <div className='w-full mt-[42px]'>
              ...
              <div className='bg-[#E3E5E4] p-1 mt-[79px]'>
                <div className='h-[385px] mb-[28px]'>
                  <img className='w-full h-full object-cover' src="/assets/testimonials/about_1.png" alt="job listing" />
                </div>
                <h4 className='text-[28px] ms-[20px] h-[48px]'>Courses Recover</h4>
              ...
              <div className='mt-10'>
                <div className='bg-[#E3E5E4] p-1 mt-[25px]'>
                  <div className='mb-[28px] h-[385px]'>
                    <img className='w-full h-full object-cover' src="/assets/testimonials/about_2.png" alt="job listing" />
                  </div>
      ...
      <section className='w-full bg-white mb-6 mt-12 mx-auto'>
        <div className='bg-[#F4F4F4] container mx-auto py-8'>
          <div className='grid lg:grid-cols-2 md:grid-cols-2 flex-wrap gap-8'>
            <div>
              <img className='w-full rounded' src="/assets/testimonials/about_3.png" alt="about_3" />
            </div>
      ...
      <section className='w-full bg-white my-[43px] mx-auto'>
        <div className='container mx-auto bg-[#F4F4F4] py-4'>
          <h2 className='text-[24px] font-semibold text-black'>Experience IT Beyond the barrier</h2>
          <div className='grid lg:grid-cols-3 md:grid-cols-2 gap-8 my-4'>
            <div className='relative'>
              <img className='w-full' src="/assets/testimonials/about_4.png" alt="about_4" />
            ...
            <div className='relative'>
              <img className='w-full' src="/assets/testimonials/about_5.png" alt="about_5" />
              <div className='absolute bottom-6 z-10'>
            ...
            <div className='relative'>
              <img className='w-full' src="/assets/testimonials/about_6.png" alt="about_6" />
            ...
            <div className='lg:w-[40%]'>
              ...
              <div className='mt-[36px] flex flex-col gap-4'>
                <div className='border w-full flex gap-4'>
                  <div className='w-[50%]'>
                    <img className='h-full' src="/assets/testimonials/about_3.png" alt="" />
                  </div>
                  <div className='my-4'>
