...
function Testimonials() {
  useEffect(() => {
      document.title = "About | IT Sikshya"
    }, []);

    const training = [
      {
        scr : "/assets/about/1.jpg",
        title : "Contribute in Live Projects "
      },
      {
        scr : "/assets/about/2.jpg",
        title : "Real World Experience"
      },
      {
        scr : "/assets/about/3.jpg",
  ...
  return (
    ...
    <section className='w-full mx-auto bg-[#8D8D8D]'>
        ...
        <div className='container mx-auto py-4'>
          <div className='flex justify-center gap-10 items-center flex-wrap'>
            <div className='flex gap-3 items-center'>
              <p className='text-[18px]'>Looking for a Career growth !</p>
              <Link to={'/apply'} className='apply'>Apply Now</Link>
            </div>
            <div className='text-[16px] font-bold'>Hybrid Training Programs</div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto py-2">
          <div className='grid lg:grid-cols-2 md:grid-cols-2 gap-14 gap-y-6'>
            <div className='rounded overflow-hidden'>
              <img className='w-full h-full object-cover' src="/assets/about/about_1.jpg" alt="" />
            </div>
            <div className='px-6 flex flex-col gap-4'>
              <h3 className='text-[26px] font-bold'>Career Support Through Real Experience</h3>
              <p className='text-[#4b4b4b] text-[15px]'>IT Sikshya’s training Program is designed to help you launch a successful career in the IT industry. Our alumni share how hands-on projects, mentorship, and structured guidance helped them build confidence and direction.</p>
              <div className='flex flex-col gap-3 text-[16px]'>
                <div className='flex items-start gap-3'>
                  <div className='p-2 mt-1 text-[15px] rounded-[100%] bg-[#0d5d59]'></div>
              ...
              <Link to={'/apply'} className='apply w-[104px]'>Apply Now</Link>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto">
          <div className='grid lg:grid-cols-2 gap-6 py-4'>
            <div className='mt-12'>
              ...
              <p className='text-[15px] my-6 pe-6'>At IT Sikshya, learning isn’t limited by location. Our virtual platform connects you to real-world IT projects, expert mentors, and a diverse community of learners from around the world.
                Experience hands-on training and professional development tailored to your goals—no matter where you're based.</p>
                <br />
                <Link to={'/apply'} className='apply w-[105px]'>Apply Now</Link>
            </div>
            <div className='rounded-[10px] overflow-hidden'>
              <img className='w-full' src="/assets/about/about_2.jpg" alt="About_2" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto py-4">
          <div className='flex flex-col lg:flex-row md:flex-row gap-6'>
            <div className='lg:w-[50%]'>
              <img className='h-[365px] w-full' src="/assets/about/testimonials_3.png" alt="testimonials_3" />
            ...
            <div className='lg:w-[100%]'>
              <img className='h-[365px] w-full' src="/assets/about/testimonials_4.png" alt="testimonials_4" />
            ...
            <div className='lg:w-[50%]'>
              <img className='h-[365px] w-full' src="/assets/about/testimonials_5.png" alt="testimonials_5" />
      ...
      <section className='max-w-[1400px] mx-auto bg-white my-6'>
        <div className="container mx-auto bg-[#E9E9E9] pt-3 pb-2">
          <h3 className='font-[600] text-[26px] my-6'>IT Training</h3>
          <div className='grid lg:grid-cols-3 gap-4 gap-y-6 md:grid-cols-3 sm:grid-cols-2'>
            {training.map((a)=>(
              <div className='w-full rounded-lg overflow-hidden'>
                <div className='h-[252px] w-full'>
              <img className='w-full h-full' src={a.scr} alt={a.title} />
              </div>
              <p className='pt-2 pb-3 bg-white px-6 font-medium text-[16px]'>{a.title}</p>
            </div>
            ))}
